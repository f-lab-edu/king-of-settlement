...
public class User {
	...
	private User(String email, String password, UserStatus activityStatus, LocalDateTime createdAt,
	...
	public static User of(String email, String password) {
		return new User(email, password, UserStatus.INACTIVE, LocalDateTime.now(), LocalDateTime.now());
	}
